...
export const RightPanel: React.FC<RightPanelProps> = ({
  ...
  return (
    <div className="relative flex">
      {/* Toggle Button - Always visible on left edge of panel area */}
      <button
        onClick={onToggle}
        className="absolute left-0 top-1/2 -translate-y-1/2 z-20 p-2 bg-nexus-800 hover:bg-nexus-700 border border-r-0 border-nexus-border rounded-l-md transition-colors text-gray-400 hover:text-nexus-accent"
      ...
      {/* Panel Content */}
      {isOpen && (
        <div className="w-80 bg-nexus-900 border-l border-nexus-border flex flex-col z-10 shadow-xl ml-8">
          {/* Header */}
